...
export default class App extends React.Component<unknown, AppStateDataType> {
  ...
  render() {
    const { connected, error, queue } = this.state;
    ...
    return (
      <Flex fullWidth fullHeight direction="column">
        <Flex justifyContent="space-between" className="queue__header" alignItems="center">
          ...
          <ActiveUsers users={this.state.activeUsers} />
        </Flex>
